...
const skills = [
    "JavaScript (ES6+)", "Python", "React.js", "Node.js", "Express.js",
     "MongoDB", "REST APIs", "Redux Toolkit", "Tailwind CSS", "HTML5 & CSS3",
    "Git & GitHub", "Docker", "WebSockets", "JWT Auth", "Postman",
    "Mongoose ODM", "Vite", "Vercel", "Render", "AWS", "CI/CD",
     "NoSQL Architecture", "Linux", "NPM", "Next.js"
];
