...
const skillCategories = [
    {
        ...
        skills: [
            ...
            { name: "JWT & RBAC Auth", level: "Expert" },
            { name: "WebSockets & Real-time ", level: "Expert" },
            { name: "Async & Event-Driven", level: "Advanced" },
            ...
            <script
                ...
                dangerouslySetInnerHTML={{
                    __html: JSON.stringify({
                        ...
                        "@type": "ItemList",
                        "name": "Technical Skills of Aditi Singh Tomar",
                        "description": "Comprehensive list of technical skills and expertise",
                        "itemListElement": [
                            { "@type": "ListItem", "position": 1, "name": "Node.js & Express.js " },
                            { "@type": "ListItem", "position": 2, "name": "RESTful APIs" },
                            { "@type": "ListItem", "position": 3, "name": "JWT & RBAC Auth" },
                    ...
                    <div className="mx-auto max-w-7xl">
                        ...
                        >
                            ...
                            <p className="mx-auto max-w-2xl text-lg text-muted">
                                ...
                                from backend Node.js frameworks to frontend React ecosystems.
                            </p>
                        </motion.div>
